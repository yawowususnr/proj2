...
public class BSTTest2 extends TestCase
{
    ...
    public void setUp() {
        ...
        Seminar seminar1 = new Seminar(1, "Seminar 1", "2024-01-01", (int)2.0, (short)2.0, (short)2.0, (int)100.0, new String[]{"AI"}, "Description 1");
        Seminar seminar2 = new Seminar(2, "Seminar 2", "2024-01-02", (int)3.0, (short)3.0, (short)3.0, (int)120.0, new String[]{"ML"}, "Description 2");
        Seminar seminar3 = new Seminar(3, "Seminar 3", "2024-01-03", (int)4.0, (short)4.0, (short)4.0, (int)130.0, new String[]{"Cloud"}, "Description 3");
        Seminar seminar4 = new Seminar(4, "Seminar 4", "2024-01-04", (int)5.0, (short)5.0, (short)5.0, (int)140.0, new String[]{"DevOps"}, "Description 4");
        Seminar seminar5 = new Seminar(5, "Seminar 5", "2024-01-05", (int)6.0, (short)6.0, (short)6.0, (int)150.0, new String[]{"Security"}, "Description 5");
    ...
    public void testRemoveNodeFromEmptyTree() {
        ...
        BSTNode<KeyValuePair<Integer, Seminar>> result = bst.removehelp(null, new KeyValuePair<>(1, node1.getElement().getValue()));
    ...
    public void testRemoveLeafNode() {
        ...
        assertEquals(node2, root.getLeft());  // node2 remains in the left subtree
    }

    
    public void testRemoveNodeWithOneChild_LeftChild() {
    ...
    public void testRemoveNodeWithOneChild_RightChild() {
    ...
    public void testRemoveNodeWithTwoChildren() {
        ...
        // Check that the root has been replaced by the maximum element in the left subtree (node2)
    ...
    public void testRemoveNonExistentNode() {
        ...
        Seminar nonExistentSeminar = new Seminar(999, "Non-existent Seminar", "2024-01-06", (int)7.0, (short)7.0, (short)7.0, (int)160.0, new String[]{"Quantum"}, "Non-existent description");
        KeyValuePair<Integer, Seminar> nonExistentPair = new KeyValuePair<>(999, nonExistentSeminar);
    ...
    public void testRemoveNodeWithSameKeyDifferentValue() {
        ...
        Seminar newSeminar = new Seminar(1, "New Seminar", "2024-02-01", (int)8.0, (short)8.0, (short)8.0, (int)170.0, new String[]{"AI"}, "New Description");
        KeyValuePair<Integer, Seminar> newPair = new KeyValuePair<>(1, newSeminar);
