    ...
    extends TestCase
{
    ...
    public void setUp()
    {
        ...
        s1 = new Seminar(1, "Title", "0610051600", 90, (short)10, (short)10, 45,
            new String[] { "keyword" }, "Description");
        s2 = new Seminar(2, "Title", "0610071600", 60, (short)10, (short)10, 30,
            new String[] { "keyword" }, "Description");
        s3 = new Seminar(10, "Title", "0701250830", 30, (short)30, (short)10,
            17, new String[] { "keyword" }, "Description");
        s4 = new Seminar(3, "Title", "1203301125", 35, (short)0, (short)0, 25,
            new String[] { "keyword" }, "Description");
    }
    ...
    public void testSearch2() {
        ...
        smallTree.insert(s3);
        smallTree.insert(s4);
        smallTree.insert(new Seminar(3, "Title", "1203301125", 35, (short)0,
            (short)70, 25, new String[] { "keyword" }, "Description"));
        smallTree.insert(new Seminar(3, "Title", "1203301125", 35, (short)70,
            (short)0, 25, new String[] { "keyword" }, "Description"));

        tree2.search(new Seminar(0, "", "", 0, (short)0, (short)0, 0,
            new String[] { "" }, ""), 0);

        smallTree.search(new Seminar(0, "", "", 0, (short)10, (short)10, 0,
            new String[] { "" }, ""), 0);

        smallTree.search(new Seminar(0, "", "", 0, (short)30, (short)10, 0,
            new String[] { "" }, ""), 0);

        smallTree.search(new Seminar(0, "", "", 0, (short)60, (short)60, 0,
            new String[] { "" }, ""), -40);

        smallTree.search(new Seminar(0, "", "", 0, (short)60, (short)60, 0,
            new String[] { "" }, ""), 40);

        smallTree.search(new Seminar(0, "", "", 0, (short)0, (short)0, 0,
            new String[] { "" }, ""), 0);
        ...
        smallTree.search(new Seminar(0, "", "", 0, (short)0, (short)80, 0,
            new String[] { "" }, ""), 10);

        smallTree.search(new Seminar(0, "", "", 0, (short)80, (short)0, 0,
            new String[] { "" }, ""), 10);

        smallTree.search(new Seminar(0, "", "", 0, (short)80, (short)80, 0,
            new String[] { "" }, ""), 10);
        ...
        smallTree.search(new Seminar(0, "", "", 0, (short)100, (short)0, 0,
            new String[] { "" }, ""), -10);

        smallTree.search(new Seminar(0, "", "", 0, (short)100, (short)100, 0,
            new String[] { "" }, ""), -10);

        smallTree.search(new Seminar(0, "", "", 0, (short)0, (short)100, 0,
            new String[] { "" }, ""), -10);
    ...
    public void testGetWorld() {
        ...
        assertEquals(99.0, world.getxMax(), 0.001);  // Max x value (worldSize - 1)
        assertEquals(99.0, world.getyMax(), 0.001);  // Max y value (worldSize - 1)
    }


    public void testSearchRadiusExactlyAtMidX() {
        // Insert seminars on both sides of the midpoint (50 in a 100x100 world)
        Seminar leftSeminar = new Seminar(1, "Left", "2023-01-01", 60, 
            (short)45, (short)50, 100, new String[] {"Test"}, "Test");
        Seminar rightSeminar = new Seminar(2, "Right", "2023-01-01", 60, 
            (short)55, (short)50, 100, new String[] {"Test"}, "Test");
        ...
        Seminar searchSeminar = new Seminar(3, "Search", "2023-01-01", 60, 
            (short)45, (short)50, 100, new String[] {"Test"}, "Test");
    ...
    public void testSearchRadiusAtMidXEdgeCase() {
        ...
        Seminar midSeminar = new Seminar(1, "Mid", "2023-01-01", 60, 
            (short)50, (short)50, 100, new String[] {"Test"}, "Test");
        
        tree.insert(midSeminar);

        // Search seminar at x=50 with radius=0
        // This tests the edge case where searchSeminar.x() + radius exactly equals midX
        Seminar searchSeminar = new Seminar(2, "Search", "2023-01-01", 60, 
            (short)50, (short)50, 100, new String[] {"Test"}, "Test");
    ...
    public void testSearchRadiusMultipleLevels() {
        // Create a tree with multiple levels by inserting seminars that force splits
        Seminar sem1 = new Seminar(1, "S1", "2023-01-01", 60, 
            (short)25, (short)25, 100, new String[] {"Test"}, "Test");
        Seminar sem2 = new Seminar(2, "S2", "2023-01-01", 60, 
            (short)75, (short)25, 100, new String[] {"Test"}, "Test");
        Seminar sem3 = new Seminar(3, "S3", "2023-01-01", 60, 
            (short)25, (short)75, 100, new String[] {"Test"}, "Test");
        Seminar sem4 = new Seminar(4, "S4", "2023-01-01", 60, 
            (short)75, (short)75, 100, new String[] {"Test"}, "Test");
        ...
        Seminar searchSeminar = new Seminar(5, "Search", "2023-01-01", 60, 
            (short)45, (short)45, 100, new String[] {"Test"}, "Test");
    ...
    public void testInsertThenRemoveToEmpty() {
        ...
        Seminar seminar = new Seminar(1, "Test Seminar", "2023-01-01", 60,
            (short)50, (short)50, 100, new String[] {"Test"}, "Test description");
    ...
    public void testEmptyNodeRemovalDuringRestructure() {
        ...
        Seminar leftSeminar = new Seminar(1, "Left", "2023-01-01", 60,
            (short)25, (short)50, 100, new String[] {"Test"}, "Test");
        Seminar middleSeminar = new Seminar(2, "Middle", "2023-01-01", 60,
            (short)50, (short)50, 100, new String[] {"Test"}, "Test");
        Seminar rightSeminar = new Seminar(3, "Right", "2023-01-01", 60,
            (short)75, (short)50, 100, new String[] {"Test"}, "Test");
        ...
        // Additional verification: try to insert a new seminar where the middle one was
        Seminar newMiddleSeminar = new Seminar(4, "New Middle", "2023-01-01", 60,
            (short)50, (short)50, 100, new String[] {"Test"}, "Test");
