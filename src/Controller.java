...
//            this.costBST.remove(seminarObject.cost());
            this.costBST.remove(new KeyValuePair<Integer, Seminar>(seminarObject.cost(), seminarObject));

//            this.dateBST.remove(seminarObject.date());
            this.dateBST.remove(new KeyValuePair<String, Seminar>(seminarObject.date(), seminarObject));
...
//                this.keywordsBST.remove(word);
    ...
    {
        System.out.println(
            "Seminars with costs in range " + String.valueOf(firstCost) + " "
                + "to " + String.valueOf(secCost) + ":");
